...
describe("Renders Markdown", () => {
  ...
  describe("transforms links correctly", () => {
    ...
    it("resolves package links to pulsar", () => {
      expect(atom.ui.markdown.render("[Hello](https://packages.pulsar-edit.dev/hey-pane)"))
        .toBe('<p><a href="https://web.pulsar-edit.dev/packages/hey-pane">Hello</a></p>\n');
    });
    it("resolves atom links to web archive", () => {
      expect(atom.ui.markdown.render("[Hello](https://docs.pulsar-edit.dev/some-docs)"))
        .toBe('<p><a href="https://web.archive.org/web/20221215003438/https://docs.pulsar-edit.dev/some-docs">Hello</a></p>\n');
    });
