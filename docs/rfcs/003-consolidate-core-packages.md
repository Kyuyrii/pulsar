...
- By reading README.md, maybe they will decide to click the link to the Atom Flight Manual and _maybe_ find the [Contributing to Official Atom Packages](https://docs.pulsar-edit.dev/hacking-atom/sections/contributing-to-official-atom-packages/) page there
