...
Snippets for the same scope must be placed within the same key. See [this section of the Pulsar Flight Manual](https://docs.pulsar-edit.dev/using-pulsar/#configuring-with-cson) for more information.
