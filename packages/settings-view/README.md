...
Want to learn more? Check out the [Getting Started: Pulsar Basics](https://docs.pulsar-edit.dev/getting-started/#pulsar-basics) and [Using Pulsar: Pulsar Packages](https://docs.pulsar-edit.dev/using-pulsar/#pulsar-packages) sections in the Pulsar Launch Manual.
...
Custom keybindings can be added by referencing the above commands.  To learn more, visit the [Using Pulsar: Basic Customization](https://docs.pulsar-edit.dev/using-pulsar/#basic-customization) or [Behind Pulsar: Keymaps In-Depth](https://docs.pulsar-edit.dev/behind-pulsar/#keymaps-in-depth) sections in the Pulsar Launch Manual.
