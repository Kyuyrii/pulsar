...
Originally [converted](https://docs.pulsar-edit.dev/core-hacking/#converting-from-textmate) from the [JSON TextMate bundle](https://github.com/textmate/json.tmbundle).
